...
let politicsOpen = document.querySelectorAll('.politics__privacy')
let politicsClose = document.querySelector('.politics__btn')
let politics = document.querySelector('#politicsModal')
let wrap= document.querySelector('.container')
let wrapPolit = document.querySelector('.container__pol')
let containerBg = document.querySelector('.container__bg')
let bannerBg = document.querySelector('.banner__bg')
politicsOpen.forEach(item => {
    item.addEventListener('click', function () {
        politics.style.display = 'flex'
        formModal.style.display = 'none'
        wrap.style.display = 'none'
        wrapPolit.style.height = '100vh'
